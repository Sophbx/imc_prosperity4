"""
trader_superman_v1.py — best-of-both merged trader for R4.
...
class Trader:
    ...
    VEV5300_ENTRY_START = 450_000
    VEV5300_ENTRY_END = 700_000
    VEV5300_EXIT_START = 880_000
