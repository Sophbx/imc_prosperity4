...
class Trader:
    ...
    M22_TRACKED_STRIKES = [5300]   # v3: only VEV_5300, where M22 reaches -250
    ...
    def _trade_ve_swing_v2(self, state: TradingState, m67_rate: float) -> List[Order]:
        ...
        # v3: drop Mark 67 acceleration delay (hurt v2 by holding past peak on day 1)
        exit_start = self.SWING_EXIT_START
        exit_force = self.SWING_EXIT_FORCE
